...
for (let i = 0; i < developers.length; i++){    
	...
	icon1.setAttribute('src',"images/icon_city.png")
	...
	icon2.setAttribute("src", "images/icon_study.png");
	...
	icon3.setAttribute("src", "images/icon_stars.png");
	...
	icon4.setAttribute("src", "images/icon_edit.png");
